...
>>>>>>> kms
  ...
  const handleSubmit = async () => {
    try {
      ...
      petData.append("etc", formData.etc);
    ...
    <div lang="ko">
      <div className="r-mid registration_total">
        ...
        <div className="re-mid">
          ...
          <div>
            <div
              className="PetRegistration-container2"
              ref={genderRef}
              tabIndex={0}
            >
              <p>성별</p>
              ...
              />
              {gender && (
                <div className="pet-registration-page-error-box">{gender}</div>
              )}
            </div>
            ...
            >
              ...
              />
              {neuter && (
                <div className="pet-registration-page-error-box">{neuter}</div>
              )}
            </div>
            {speciesDetails.map((detail, index) => (
              <div key={index} className="PetRegistration-container2">
