                        ...
                        <div className='notice-list-container' key={index}>
                            <div className='text-container'>
                                <div className='list-title-container'>
                                    ...
                                    <div className='notice-content'>{list.address_road}{list.address_detail}</div>
                                    <div className='notice-content'>{list.date}</div>
                                </div>
                            </div>
                            <button className='notice-button' style={{ cursor: 'pointer' }} onClick={() => navigate(`/notice/${list.beauty_notice_id}/`)} >알림장 보기</button>
                        </div>
                    ))
                }
            </div>
