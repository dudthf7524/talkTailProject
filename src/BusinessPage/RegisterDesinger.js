        ...
        <div className='mid' lang='ko'>
            ...
            <div className='main-mid'>
                <div className='input-container'>
                    <p>디자이너 이름</p>
                    <input type='text' name='business_desinger_name' value={formData.business_desinger_name} onChange={handleInputChange} placeholder='상호명을 입력해 주세요.' />
                </div>
                
                <div className='input-container'>
                    <p>소개글</p>
                    <div className="textarea-wrapper">
                        <textarea id='greetingTextarea' name='business_desinger_introduce' value={formData.business_desinger_introduce} onChange={handleInputChange} />
                    </div>
                </div>
