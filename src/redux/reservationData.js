...
const reservationDataSlice = createSlice({
    ...
    initialState: {
        ...
        desiredReservationTime: null,  // 예약 희망시간을 저장할 상태
    ...
    reducers: {
        ...
        setDesiredReservationTime: (state, action) => {
            state.desiredReservationTime = action.payload; // 디자이너 이름 업데이트
        },
...
export const { setDesignerName, setDesiredReservationTime, setPetId, setBusinessInfo } = reservationDataSlice.actions;
